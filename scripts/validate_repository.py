...
COMMON_REQUIRED = [
    ...
    ".agents/skills/code-review/references/review-storage.md",
    ".agents/skills/code-review/references/aggregation-and-gate.md",
    ".agents/skills/code-review/config/review-policy.example.json",
    ".agents/skills/code-review/config/dimension-registry.example.json",
    ".agents/skills/code-review/config/seam-registry.example.json",
    ".agents/skills/code-review/config/evidence-requirements.example.json",
    ".agents/skills/code-review/config/review-triggers.example.json",
    ".agents/skills/code-review/schemas/finding.schema.json",
    ".agents/skills/code-review/schemas/review-result.schema.json",
    ".agents/skills/code-review/schemas/coordination.schema.json",
    ".agents/skills/code-review/schemas/evidence-manifest.schema.json",
    ".agents/skills/code-review/schemas/finding-ledger.schema.json",
    ".agents/skills/code-review/schemas/aggregate-review.schema.json",
    ".agents/skills/code-review/schemas/merge-gate.schema.json",
    ".agents/skills/code-review/scripts/review_store.py",
    ".agents/skills/code-review/scripts/reconcile_findings.py",
    ".agents/skills/code-review/scripts/aggregate_reviews.py",
    ".agents/skills/code-review/scripts/evaluate_merge_gate.py",
    ".agents/skills/code-review/scripts/validate_review_artifacts.py",
    ".agents/skills/code-review/templates/repository-state.json",
