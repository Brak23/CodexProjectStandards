...
- [`work/`](work/README.md): Feature briefs, execution plans, UX requirements, decisions, verification evidence, and UI evidence.

Do not use chat history, design-tool comments, PR descriptions, or issue comments as the only authoritative record for lasting product, design, or architecture decisions.
